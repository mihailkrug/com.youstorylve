...
public class MyTouchIvent extends GridView {
    ...
    public MyTouchIvent(Context context) {
        super(context);
        init(context);
    }

    public MyTouchIvent(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MyTouchIvent(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(final Context context) {
        gDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                                   float velocityY) {
                final int position = MyTouchIvent.this.pointToPosition
